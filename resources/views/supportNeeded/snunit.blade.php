...
@section('title', 'SUPPORT NEEDED UNIT')
...
<div class="collab-container">
    ...
    <div class="collab-header">
        <div class="header-left">
            <h1 class="page-title">SUPPORT NEEDED UNIT</h1>
        </div>
    ...
    <div class="collab-table-container">
        <table class="collab-table">
            ...
            <tbody>
                @forelse($allsnunit as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $item->event }}</td>
                    <td>{{ $item->unit }}</td>
                    ...
                    <td>
                        ...
                        <form action="{{ route('snunit.destroy', $item->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="12" style="text-align: center; font-weight: normal;">Belum ada data Support Needed UNIT</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <form action="{{ route('snunit.store') }}" method="POST" onsubmit="return validateAddForm()">
                        @csrf
                        <div class="modal-header" style="background-color: #4A0E4E; color: #fff;">
                            <h5 class="modal-title" id="addModalLabel">Tambah Data Support Needed UNIT</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
