...
@section('title', 'ESKALASI TO TSEL')
...
<div class="collab-container">
    ...
    <div class="collab-header">
        <div class="header-left">
            <h1 class="page-title">ESKALASI TO TSEL</h1>
        </div>
    ...
    <div class="collab-table-container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('tsel.destroy', $item->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="12" style="text-align: center; font-weight: normal;">Belum ada data Eskalasi to TSEL</td>
                </tr>
                @endforelse
            </tbody>
        </table>
                ...
                <div class="modal-content">
                    <form id="editForm" method="POST">
                        ...
                        <div class="modal-header" style="background-color: #4A0E4E; color: #fff;">
                            <h5 class="modal-title">Edit Data Eskalasi To TSEL</h5>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <form action="{{ route('tsel.store') }}" method="POST" onsubmit="return validateAddForm()">
                        @csrf
                        <div class="modal-header" style="background-color: #4A0E4E; color: #fff;">
                            <h5 class="modal-title" id="addModalLabel">Tambah Data Eskalasi To TSEL</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
