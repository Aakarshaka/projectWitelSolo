...
@section('title', 'SUPPORT NEEDED AM')
...
<div class="collab-container">
    ...
    <div class="collab-header">
        <div class="header-left">
            <h1 class="page-title">SUPPORT NEEDED AM</h1>
        </div>
    ...
    <div class="collab-table-container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('snam.destroy', $item->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                ...
                <div class="modal-content">
                    <form id="editForm" method="POST">
                        ...
                        <div class="modal-header" style="background-color: #4A0E4E; color: #fff;">
                            <h5 class="modal-title">Edit Data Support Needed AM</h5>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <form action="{{ route('snam.store') }}" method="POST" onsubmit="return validateAddForm()">
                        @csrf
                        <div class="modal-header" style="background-color: #4A0E4E; color: #fff;">
                            <h5 class="modal-title" id="addModalLabel">Tambah Data Support Needed AM</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
